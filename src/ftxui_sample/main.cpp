...
// configuration step. It creates a namespace called `tiit_cpp`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", tiit_cpp::cmake::project_name, tiit_cpp::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", tiit_cpp::cmake::project_version);
      return EXIT_SUCCESS;
    }
